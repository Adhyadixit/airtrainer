...
import {
    Send, Users, Plus, X, Clock, MapPin, DollarSign,
    Star, ChevronRight, Filter, Search, Calendar, MessageSquare, Zap, Award
} from "lucide-react";
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "grid", gap: "18px" }}>
                            ...
                            <label style={{
                                ...
                                <div style={{ flex: 1 }}>
                                    <p style={{ fontWeight: 600, fontSize: "14px", color: "#0f172a" }}>🎉 Add Intro Session Discount</p>
